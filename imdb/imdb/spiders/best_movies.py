...
class BestMoviesSpider(CrawlSpider):
    ...
    def start_requests(self):
        yield scrapy.Request(url='https://web.archive.org/web/20200715000935/https://www.imdb.com/search/title/?groups=top_250&sort=user_rating', headers={'User-Agent': self.user_agent})
